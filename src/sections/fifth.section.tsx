    ...
    return (
        <section className={'mx-auto container'}>
            <div
                ...
                <div
                    className={"how-does-it-work-cards mt-[24px] lg:mt-[36px] grid grid-cols-1 items-start  md:grid-cols-2  lg:grid-cols-3 gap-5"}>
                    ...
                    <div className={'grid grid-cols-1 md:order-1 lg:order-0 gap-5'}>
                        <div className={"hidden lg:block"}>
                            <img className={'2xl:w-full 2xl:max-h-[347px] object-cover object-top rounded-[12px]'}
                                 src={'/img/men.svg'} alt={'men'}/>
                        </div>
