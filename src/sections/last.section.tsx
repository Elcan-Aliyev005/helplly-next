        ...
        <section>
            ...
            <div
                ...
                <div className={'lg:w-5/9 2xl:w-6/9'}>
                    <h4 className={'leading-[16px] text-xs  lg:text-[16px] lg:leading-6 lg:mb-2 mb-1'}>Bizə qatıl</h4>
                    ...
                    <p className={'text-[14px] lg:pr-[80px] lg:max-w-8/10  lg:text-[16px] mb-8 text-[#ffffffad] leading-6'}> Uyğun icraçı tapmaq və paylaşılan işlərə icraçı kimi istək göndərmək üçün Helplly-ni yükləyin. Prosesi sadə və rahat şəkildə idarə edin.
                    </p>
