...
function WhoIsExecutorSection() {
    return (
        <section className={'bg-[url("/img/who-is-executor-banner-mobile.svg")] mb-10  lg:mb-21  lg:bg-[url("/img/who-is-executor-banner.svg")] bg-cover bg-center ' +
            ...
            <div className="right text-[#fff] lg:w-[600px] xl:w-[653px]
             ...
             lg:px-0  font-manrope ">
                <SectionName circleClassName={"!bg-[#FFFFFF99]"} className={'!text-[#fff] mb-2'}>İcraçı kimdir?</SectionName>
                <h3 className={'text-[16px] lg:text-[45px] leading-[52px] lg:font-bold mb-2 lg:mb-3 leading-6 font-semibold max-w-[103px] lg:max-w-[450px]'}>Helplly-də icraçılar kimlər ola bilər?</h3>
                <p className={'leading-4 text-[10px] lg:leading-6 lg:text-[16px] text-[#FFFFFF99] max-w-[177px] lg:max-w-[553px]'}>
