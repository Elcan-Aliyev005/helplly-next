    ...
    if (type == "with-bg-image") {
        return (
            <div
                ...
                <div className={'text-[#FFFFFFBF] leading-6 text-sm lg:text-[16px]'} dangerouslySetInnerHTML={{__html: description}} />
                </div>
        ...
        return (
            <div className={'bg-[#E7F3E7] rounded-[12px] px-[20px] lg:px-[24px] py-[24px]  lg:py-[32px]'}>
                ...
                <div className={'text-[#00000099] leading-6 max-w-[362px] text-sm lg:text-[16px]'} dangerouslySetInnerHTML={{__html: description}} />
            </div>
        )
    }
}
